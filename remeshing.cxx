...
void compute_metric_field(const Variables &var, const conn_t &connectivity, const double resolution, double_vec &metric, elem_cache &tmp_result)
{
              ...
              const segment_t &original_segment, const segflag_t &original_segflag)
{
    ...
    compute_metric_field(var, old_connectivity, param.mesh.resolution, *var.ntmp, *var.tmp_result);
