...
int MMG_cuthex(pMesh ,pHedge ,pHexa ,int* ,int ,int);
...
int MMG_boulcol(pMesh ,int ,int ,pList );
int MMG_coquil(pMesh ,int ,int ,pList );
int MMG_coquilgen(pMesh ,int ,int ,pList ) ;
int MMG_cendel(pMesh ,pSol ,double ,int );
int MMG_cendel_LES(pMesh ,pSol ,double ,int);
int MMG_spledg(pMesh ,pSol ,pQueue ,pList ,int ,double ,double );
int MMG_cendel23(pMesh ,pSol ,double ,int );
...
int MMG_colvert(pMesh mesh, pSol sol, int base);
/* hash */
int  MMG_hashTetra(pMesh );
int MMG_hashHexa(pHexa ,int* ,int );
...
int  MMG_optra4_LES(pMesh ,pSol );
int  MMG_optcoq(pMesh ,pSol);
int  MMG_opttet(pMesh ,pSol);
int  MMG_opttyp(pMesh ,pSol ,double ,int *,int );
...
int    MMG_count(pMesh ,pSol , double *, long *);
...
int  MMG_searchqua(pMesh,pSol,double,int*);
int  MMG_searchlen(pMesh,pSol,double,double,int*);
...
double MMG_long_ani_init(double *,double *,double *,double *) ;
...
int    MMG_optlen_LES(pMesh ,pSol ,double ,int );
