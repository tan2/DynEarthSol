...
int renumbering(int boxVertNbr, MMG_pMesh mesh, MMG_pSol sol) {
  ...
  CHECK_SCOTCH(SCOTCH_graphBuild(&graf, baseVal, vertNbr, vertTab+1, vendTab+1, NULL, NULL, edgeNbr, edgeTab+1, NULL), "scotch_graphbuild", 0) ;
