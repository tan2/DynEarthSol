                               ...
                               Param &p)
{
    ...
    cfg.add_options()
        ...
        // for temperature_option = 90 only
        ("ic.Temp_filename", po::value<std::string>(&p.ic.Temp_filename)->default_value("eapsi_thermal_HD.dat"),
	"Filename of the input thermal profile, for temperature_option = 90 only.\n"
	"The file format is,\n"
	"x-coord y-coord z-coord(if in 3D) temperature.\n"
	"Canbe generated by COMSOL.")
	("ic.Nodes_filename", po::value<std::string>(&p.ic.Nodes_filename)->default_value("EAPSI_Coord_HD.dat"),
	"Filename of the Mesh-nodes, for temperature_option = 90 only.\n"
	"It maybe ordered differently with the thermal profile. The file format is,\n"
	"x-coord y-coord z-coord(if in 3D).\n"
	"Canbe generated by COMSOL.")
	("ic.Connectivity_filename", po::value<std::string>(&p.ic.Connectivity_filename)->default_value("EAPSI_Connectivity_HD.dat"),
	"Filename of the Mesh connectivity, for temperature_option = 90 only.\n"
	"The file format is,\n"
	"#ofnode0 #ofnode1 #ofnode2 #ofnode3(if in 3D and tetrahedral).\n"
	"Canbe generated by COMSOL.")
