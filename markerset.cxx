...
//            #pragma omp critical
            {
                append_marker(eta1, e, mattype, var.time / YEAR2SEC);
                ++elemmarkers[e][mattype];
            }
//            #pragma omp critical(deposit)
            std::cout << "A " << mattype << " marker generated by surface processes in element " << e << ".\n";
        }
        else {
            int new_elem, inc;

//            #pragma omp critical(deposit)
            std::cout << "A " << mattype << " marker generated by surface processes in element " << e << " is trying to remap in element ";
...
//                #pragma omp critical(add_marker)
                {
                    append_marker(eta1, new_elem, mattype, var.time / YEAR2SEC);
...
void MarkerSet::correct_surface_marker(const Variables& var, const double_vec& dhacc,
                                       double_vec& plstrain, tensor_t& strain)
{
