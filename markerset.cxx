...
void MarkerSet::set_sediment_marker(const Variables& var, const int mattype_sed, array_t& edhacc, int_vec2D& elemmarkers)
{
...
//            printf("%d ",e);
        ...
        if (dv / (*var.volume)[e] < 0.1) continue;
...
//            std::cout << "A sediment marker generated in element " << e << ".\n";
        }
        else {
            int new_elem, inc;

//            #pragma omp critical(deposit)
            std::cout << "A sediment marker generated in element " << e << " is trying to remap in element ";
...
//                #pragma omp critical
                ...
                std::cout << "... Sediment marker generated fail!\n";
