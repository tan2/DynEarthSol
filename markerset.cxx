...
void MarkerSet::set_sediment_marker(const Variables& var, const int mattype_sed, array_t& edhacc, int_vec2D& elemmarkers, double_vec& plstrain)
{
...
//            #pragma omp critical
            {
                append_marker(eta1, e, mattype_sed, var.time / YEAR2SEC);
                ++elemmarkers[e][mattype_sed];
            }
//            #pragma omp critical(deposit)
            std::cout << "A marker generated by surface processes in element " << e << ".\n";
        }
        else {
            int new_elem, inc;

//            #pragma omp critical(deposit)
            std::cout << "A marker generated by surface processes in element " << e << " is trying to remap in element ";
...
//                #pragma omp critical(add_marker)
                {
                    append_marker(eta1, new_elem, mattype_sed, var.time / YEAR2SEC);
                    ++elemmarkers[new_elem][mattype_sed];
                }
//                #pragma omp critical
                std::cout << "... Success!\n";
            }
...
void MarkerSet::correct_surface_marker(const Variables& var, const double_vec& dhacc)
{
