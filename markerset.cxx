...
void MarkerSet::set_surface_marker(const Variables& var, const int mattype, array_t& edhacc, int_vec2D& elemmarkers)
{
#ifdef USE_NPROF
    nvtxRangePushA(__FUNCTION__);
#endif
...
//    #pragma omp parallel for default(none) shared(var,mattype,edhacc,elemmarkers,src_locs,src_abj,std::cout)
